    ...
    try {
      ...
      const msg =
        error instanceof Error
          ? error.message
          : "Không thể tải danh sách permissions";
      toast({
        title: "Lỗi",
        description: msg,
        variant: "destructive",
  ...
  const handleCreate = async () => {
    ...
    if (!/^[a-z_]+\.[a-z_]+$/.test(formData.name)) {
      toast({
        title: "Lỗi",
        description:
          "Tên permission phải theo format: module.action (vd: movies.create)",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      const msg =
        error instanceof Error ? error.message : "Không thể tạo permission";
      toast({
        title: "Lỗi",
        description: msg,
        variant: "destructive",
      ...
      <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Thêm permission mới vào hệ thống. Tên phải theo format:
              module.action
            </DialogDescription>
          </DialogHeader>
