        ...
        <div className="max-w-2xl mx-auto p-4">
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    {/* Result Section */}
                    {result && (
                        <Alert variant={result.success ? 'default' : 'destructive'} className="animate-fade-in">
                            {result.success ? (
                            ...
                            <CardContent className="pt-6 space-y-3">
                                ...
                                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-green-200 dark:border-green-800">
                                    <div className="flex items-center gap-2 text-green-800 dark:text-green-200">
                                        ...
                                        <div>
                                            <p className="text-xs text-green-600 dark:text-green-400">Giờ chiếu</p>
                                            <p className="font-semibold">
                                                {new Date(result.ticket.showtimeStart).toLocaleTimeString('vi-VN', {
                                                    hour: '2-digit',
                                                    minute: '2-digit',
                                                })}
                                            </p>
                                    ...
                                    <div className="flex items-center gap-2 text-green-800 dark:text-green-200">
                                        ...
                                        <div>
                                            <p className="text-xs text-green-600 dark:text-green-400">Ghế</p>
                                            <p className="font-semibold">
                                                {result.ticket.rowNumber}{result.ticket.seatNumber}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-2 text-green-800 dark:text-green-200">
                                        ...
                                        <div>
                                            <p className="text-xs text-green-600 dark:text-green-400">Phòng</p>
                                    ...
                                    <div className="flex items-center gap-2 text-green-800 dark:text-green-200">
                                        ...
                                        <div>
                                            <p className="text-xs text-green-600 dark:text-green-400">Loại ghế</p>
                                            <p className="font-semibold">{result.ticket.seatTypeName}</p>
                                        </div>
                                    </div>
                                </div>
                            </CardContent>
                    ...
                    {result && !result.success && result.message.includes('chưa mở cửa') && (
                        <Alert variant="default" className="border-yellow-500 bg-yellow-50 dark:bg-yellow-950">
                            <AlertTriangle className="h-4 w-4 text-yellow-600" />
                            <AlertDescription className="text-yellow-800 dark:text-yellow-200">
                                Khách hàng đến quá sớm. Vui lòng yêu cầu quay lại sau 30 phút trước giờ chiếu.
                            </AlertDescription>
                        </Alert>
                    )}
                    ...
                    <div className="mt-6 p-4 bg-muted rounded-lg">
                        ...
                        <ul className="text-xs text-muted-foreground space-y-1">
                            ...
                            <li>• Vé hợp lệ sẽ tự động chuyển sang trạng thái "Đã sử dụng"</li>
                            <li>• Khách được vào trước 30 phút và chậm nhất 15 phút sau giờ chiếu</li>
