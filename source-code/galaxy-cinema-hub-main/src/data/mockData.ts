import { Movie, Cinema, Showtime, ConcessionItem, User, Booking, Transaction, Review } from '@/types/cinema';
...
export const movies: Movie[] = [
  {
    ...
    description: 'Câu chuyện về Mai, một người phụ nữ với quá khứ đầy thương tổn nhưng vẫn giữ vững niềm tin vào tình yêu và cuộc sống.',
  ...
  },
  {
    ...
    description: 'Bối cảnh Hà Nội những ngày cuối cùng của cuộc kháng chiến chống Pháp, câu chuyện tình yêu giữa chiến tranh.',
    rating: 4.5,
    isNowShowing: true,
  },
  {
    ...
    description: 'Po tiếp tục hành trình trở thành bậc thầy võ thuật khi đối mặt với kẻ thù mới.',
    rating: 4.2,
    isNowShowing: true,
  },
  {
    ...
    description: 'Paul Atreides hợp tác với Chani và người Fremen để trả thù cho sự sụp đổ của gia đình mình.',
    rating: 4.9,
    isNowShowing: true,
  },
  {
    ...
    description: 'Hai titan huyền thoại hợp sức chống lại mối đe dọa chưa từng có.',
    rating: 4.0,
    isNowShowing: false,
  },
  {
    ...
    description: 'Câu chuyện cảm động về tình cảm gia đình và những ước mơ giản dị.',
    rating: 4.6,
    isNowShowing: false,
  },
];
...
export const generateShowtimes = (movieId: string, cinemaId: string): Showtime[] => {
...
export const concessions: ConcessionItem[] = [
  ...
  },
  {
    ...
    price: 199000,
    quantity: 0,
    image: 'https://images.unsplash.com/photo-1512149177596-f817c7ef5d4c?w=200&h=200&fit=crop',
  },
  {
    id: 'drink-1',
...
export const mockBookings: Booking[] = [
  {
    ...
    seats: [
      { id: 'F5', row: 'F', number: 5, type: 'vip', status: 'sold', price: 120000 },
      { id: 'F6', row: 'F', number: 6, type: 'vip', status: 'sold', price: 120000 },
    ],
  ...
  for (let i = 0; i < rows; i++) {
    ...
    for (let j = 1; j <= seatsPerRow; j++) {
      ...
      row.push({
        ...
        status: soldChance > 0.7 ? 'sold' : soldChance > 0.6 ? 'held' : 'available',
